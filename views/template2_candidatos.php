...
<div id="c2">
  ...
  <?PHP endif;?>
    ...
    <div class="bloque">
        ...
        <div class="fila">
    <h1>Candidatos</h1> <span class="tit01">Necesitas un curriculum?</span>
    </div>
...
<?PHP if($h=='login'):?>
    <a href="<?PHP echo site_url('registros/candidato');?>" class="boton01 flecha">Registrate</a>
    <?PHP else:?>
    <a href="<?PHP echo site_url('login/candidato');?>" class="boton01 flecha">Ingresa</a>
