...
<meta property="og:title" content="<?PHP _etiqueta_titulo($_titulo_); ?>" />
...
<link href="<?PHP echo base_url('/css/empleate-sistemas-unmsm.css')?>" rel="stylesheet" type="text/css" />
...
<div class="pagina pagina_superior">
...
<div class="pagina pagina_cuerpo">
...
<div class="bloque">
<div class="fila">
<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.hayempleo.com&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21&amp;appId=335046663209679" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe>
</div>
...
foreach($resultado as $key => $val):
    if($key<5):
    echo "<li class='c".$key."'><a href='".$resultado[$key]->link."'>".$resultado[$key]->title."</a></li>";
	endif;
    endforeach;
echo "</ul>";
