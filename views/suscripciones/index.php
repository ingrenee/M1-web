...
<div class="fila">
  ...
  <p>Ingresa tu email, verifica de que este escrito correctamente.</p>
...
Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
<?PHP echo form_input('email',set_value('email'),' class="largo" id="email" ');?>

<?PHP echo form_error('email');?>

</div>

<div class="fila campos"> Repetir e-mail:

<?PHP echo form_input('re_email',set_value('re_email'),' class="largo" id="email" ');?>
